    ...
    return (
        <div>
            <div className="relative h-96 w-full  grid flex-col items-end justify-center overflow-hidden  bg-white bg-clip-border text-center text-gray-700">
                ...
                <div>
                     <img className="absolute inset-0 m-0  rounded-none bg-transparent h[750px] w-[1260] bg-cover bg-clip-border bg-center text-white-700 shadow-none" src="/resources/cover-img.png" alt="cover-pic" />
