    ...
    return (
        <div className="">
            ...
            <div className="absolute inset-0 m-0  rounded-none bg-transparent bg-[url('../../../public/resources/cover-img.png')] h[750px] w-[1260] bg-cover bg-clip-border bg-center text-white-700 shadow-none">
                 <div className="to-bg-black-10 absolute inset-0  h-full w-full bg-white opacity-90 "></div>
            </div>

            <div className= "mx-auto w-full lg:w-[1240px]  py-2 px-4  lg:px-8 lg:py-4">
            
                    <div className="relative" >
                    <nav className="flex justify-between items-center text-lg font-bold px-5">
                        <Logo></Logo>
                ...
                <div className="relative p-6 py-32 px-6">
                 <h2 className="mb-6 block text-[#0B0B0B] text-4xl font-bold">
                 I Grow By Helping People In Need
                 </h2>
                 

            <form className="w-[470px] height:[50px]; mx-auto">   
